                ...
                <form action="" method="post">
                    <div class="button-container">
                        <button type="submit" class="btn btn-primary <?php if (isset($_POST['get'])) {
                                                                            echo 'hidden';
                                                                        } ?>" name="get">Ambil</button>
                        <a href="read2.php" class="btn btn-primary ">Balas</a>
                        <a href="1.html" class="btn btn-warning ">Reaction</a>
                        <a href="pohon.php" class="btn btn-secondary">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
